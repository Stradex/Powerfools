...
var InvalidTroop: Dictionary = {
	...
	idle_cost_per_turn = 0, #cost of this troop per turn while doing nothing
	moving_cost_per_turn = 0, #cost of this troop per turn while traveling
	battle_cost_per_turn = 0, #cost of this troop per turn while fighting
